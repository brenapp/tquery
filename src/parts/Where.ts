...
export type WhereEquals<Table extends GenericTableKind, Field extends keyof Table["Shape"]> = Field extends string ? {
    _brand: "WHERE_CLAUSE"
...
export type WhereIsNull<Table extends GenericTableKind, Field extends keyof Table["Shape"]> = Field extends string ? {
    _brand: "WHERE_CLAUSE"
...
export type WhereIsNotNull<Table extends GenericTableKind, Field extends keyof Table["Shape"]> = Field extends string ? {
    _brand: "WHERE_CLAUSE"
...
export type WhereClausesSQL<Clauses extends QueryKind<"WHERE_CLAUSE">[]> = 
    Clauses extends [infer H extends QueryKind<"WHERE_CLAUSE">] 
        ? [H["SQL"]] 
        : Clauses extends [infer H extends QueryKind<"WHERE_CLAUSE">, ...infer T extends QueryKind<"WHERE_CLAUSE">[]]  
            ? [H["SQL"], ...WhereClausesSQL<T>]
            : never

export type WhereClausesBindParameters<Clauses extends QueryKind<"WHERE_CLAUSE">[]> = 
            Clauses extends [infer H extends QueryKind<"WHERE_CLAUSE">] 
                ? [...H["BindParameters"]] 
                : Clauses extends [infer H extends QueryKind<"WHERE_CLAUSE">, ...infer T extends QueryKind<"WHERE_CLAUSE">[]]  
